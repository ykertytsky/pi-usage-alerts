...
- Redesigned the in-Pi alert display to be minimal: removed the multi-line banner below the editor and replaced the vague `usage: critical` status with a compact status-bar segment carrying the key numbers (e.g. `usage 1% left · resets 57m`, `usage exhausted · resets 57m`, `usage rate-limited`).
...
[0.2.0]: https://github.com/ykertytsky/pi-usage-alerts/releases/tag/v0.2.0
